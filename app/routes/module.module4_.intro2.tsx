...
export default function Intro2Module4() {
	return (
		<Container pageTitle="Purpose in Each Part of My Life" nextEnabled={true}>
			...
			<div className=" shadow-lg sm:rounded-lg w-10/12 mx-auto overflow-y-auto mb-7 border border-black">
				<table className="w-full text-left rtl:text-right text-black text-lg">
					<thead className="uppercase bg-[#bcbcbc]">
						<tr>
					...
					<tbody>
						<tr className="odd:bg-[#ffffff] even:bg-[#bcbcbc] even:text-black border-b border-gray-700">
